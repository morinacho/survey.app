<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="navbar-brand" href="<?php echo URL_ROUTE ?>home">
    <img src="<?php echo URL_ROUTE ?>media/logo.png" width="30" height="30" class="d-inline-block align-top" alt=""> 
    Survey app
  </a>
      ...
      <li class="nav-item">
        ...
        <?php else :?>
          ...
          <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="<?php echo URL_ROUTE ?>surveys/show">Ver encuestas</a>
            <a class="dropdown-item" href="<?php echo URL_ROUTE ?>surveys/export">Exportar a excel</a>
